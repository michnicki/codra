/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-env.d.ts` (hash: cb92c2d7fb3eaeed3cd99d0cf00c0271)
...
interface __BaseEnv_Env {
	...
	INDEX_WORKFLOW: Workflow<Parameters<import("./index").IndexWorkflow['run']>[0]['payload']>;
}
