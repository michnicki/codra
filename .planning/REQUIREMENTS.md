...
- [x] **PRD-02**: Title truncation to 80 chars — truncate `title` field of parsed review comments exceeding 80 characters; clear `suggestion` to null when it equals `existingCode` after trim (FR-153/154)
